import { RowSizesEnum, TableCustomEvents } from './models/optimized-data-table.model';
...
export const DEFAULT_CONFIG = {
	...
	filters: [
		{
			...
			type: 'in',
			label: 'Estado',
			value: ['Issued', 'Issued2']
		},
		{
			field: 'invoiceAmount',
			fieldTitle: 'Invoice amount',
			type: '>',
	...
	literals: {
		...
		showAll: 'Show hidden fields',
		hideAll: 'Hide shown fields',
		...
		titleColumnShown: 'Shown in custom view',
		titleColumnHidden: 'Hidden in custom view',
		...
		paginationSizeAll: 'All',
		titleCustomViews: 'Custom views',
		messageMaxColumnsPerView:
			'It is not possible to show more than 20 fields in the custom view. Use the filter or select the fields one by one.',
		separtorMaxColumnsPerView: ' of ',
		tooltipShowAll: 'Add hidden fields in the custom view.',
		emptyStateTableDescription: 'Try to change the search inputs to get other results. Custom By Literals',
		emptyStateTableTitle: 'No results found custom By Literals'
	},
	name: 'Securizations',
	...
	config: {
		...
		language: 'en',
		tooltipDelay: 500,
		maxColumnsPerView: 8, // use undefined for no limit
		emptyStateTablePathIcon: '/assets/images/i-laptop-coffee.svg'
	},
	itemList: [
		{
			title: 'Default views',
...
export const DEFAULT_CONFIG_TOOLTIP_ROW = {
	analytics: {
		label01: 'ui_kit',
		eventCategory: 'ui_kit'
	},
