...
const meta: Meta = {
	...getStoryConfig('scib-cdk-signature-modal-documentation'),
	title: 'Design System/DEPRECATED/CDK/Signature Modal Documentation',
	render: (args) => <scib-cdk-signature-modal-documentation {...args} />
};
export default meta;
